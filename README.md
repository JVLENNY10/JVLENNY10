<a href="https://www.linkedin.com/in/jvlenny10/" style="margin-left:auto;">
  <img src="https://img.shields.io/badge/LinkedIn-0A66C2?style=for-the-badge&logo=linkedin&logoColor=white" style="border-radius: 8px;" />
</a>

## Experiência                                                                                         
<p>
  Desenvolvedor Back-End com experiência na construção e evolução de APIs REST, microsserviços e integrações entre sistemas, atuando com foco em escalabilidade, performance, confiabilidade e sustentação em produção.

Tenho vivência com .NET, Node.js, SQL Server, MongoDB, Redis e RabbitMQ, além de participação em rotinas de deploy e versionamento em ambientes AWS, com uso de Docker, GitHub Actions e suporte operacional em Kubernetes.
...
<ul>
 <li>.NET e Node.js</li>
 <li>APIs REST e microsserviços</li>
 <li>SQL Server, MongoDB e Redis</li>
 <li>RabbitMQ e integrações entre sistemas</li>
 <li>AWS, Docker e CI/CD com GitHub Actions</li>
...
<div align="center">
  ...
  <img alt="rabbitmq-logo" height="40" src="https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/rabbitmq/rabbitmq-original.svg" width="52" />
